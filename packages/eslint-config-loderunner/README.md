...
Using oxlint/oxfmt instead? →
[`oxc-config-loderunner`](../oxc-config-loderunner/README.md)
...
| Rule                                                                                      | Description                                                                |
| ----------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| [loderunner/no-chained-arrow](../eslint-plugin-loderunner/docs/rules/no-chained-arrow.md) | Disallow arrow functions whose expression body is itself an arrow function |
